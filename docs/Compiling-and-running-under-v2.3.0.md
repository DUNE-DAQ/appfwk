...
```bash
git clone https://github.com/DUNE-DAQ/daq-buildtools.git -b v2.2.1  # v2.2.1 corresponds to the dunedaq-v2.3.0 release
```
...
```
cd sourcecode
git clone https://github.com/DUNE-DAQ/listrev.git -b v2.1.1 # v2.1.1 corresponds to the dunedaq-v2.3.0 release
cd ..
```
...
* [[Creating a new package under v2.3.0|Creating a new package under v2.3.0]]
