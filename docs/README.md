...
class MyDaqModule : public dunedaq::appfwk::DAQModule {
  ...
  private:
     ...
     std::shared_ptr<dunedaq::iomanager::ReceiverConcept<MyType2>> m_type2_receiver;
};
```
* `MyDaqModule.cpp`:
```C++
...
[!!! Here we need to remake this diagram]![Class Diagrams](https://github.com/DUNE-DAQ/appfwk/raw/develop/docs/appfwk.png)
