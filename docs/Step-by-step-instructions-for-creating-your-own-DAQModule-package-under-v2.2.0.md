...
* [[Compiling and running the App Fwk|Compiling-and-running-under-v2.2.0]]
* [[Creating a new package|Creating-a-new-package-under-v2.2.0]]
...
In order to run the example package follow the instruction in the [[dedicated section|Step-by-step-instructions-for-creating-your-own-DAQModule-package-under-v2.2.0#Running the example package]].
