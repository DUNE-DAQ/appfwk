...
public:
  ...
  virtual void do_stuff(const nlohmann::json& /*data*/) = 0;
};
...
public:
  ...
  void do_bad_stuff(const nlohmann::json&) { throw DummyModuleUpdate(ERS_HERE, get_name(), "DummyModule do_bad_stuff"); }

  void do_stuff(const nlohmann::json& /*data*/) override
  {
