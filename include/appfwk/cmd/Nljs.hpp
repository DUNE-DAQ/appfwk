...
inline void
to_json(data_t& j, const AddressedCmd& obj)
{
  j["match"] = obj.match;
  j["data"] = obj.data;
}
...
inline void
from_json(const data_t& j, AddressedCmd& obj)
{
  if (j.contains("match"))
...
inline void
to_json(data_t& j, const CmdObj& obj)
{
  j["modules"] = obj.modules;
}

inline void
from_json(const data_t& j, CmdObj& obj)
{
...
inline void
to_json(data_t& j, const Command& obj)
{
  j["id"] = obj.id;
  j["data"] = obj.data;
}
...
inline void
from_json(const data_t& j, Command& obj)
{
  if (j.contains("id"))
...
inline void
to_json(data_t& j, const QueueSpec& obj)
{
  j["kind"] = obj.kind;
  j["inst"] = obj.inst;
...
inline void
from_json(const data_t& j, QueueSpec& obj)
{
  if (j.contains("kind"))
...
inline void
to_json(data_t& j, const ModSpec& obj)
{
  j["plugin"] = obj.plugin;
  j["inst"] = obj.inst;
  j["data"] = obj.data;
...
inline void
from_json(const data_t& j, ModSpec& obj)
{
...
inline void
to_json(data_t& j, const Init& obj)
{
  j["queues"] = obj.queues;
  j["modules"] = obj.modules;
}
...
inline void
from_json(const data_t& j, Init& obj)
{
...
inline void
to_json(data_t& j, const QueueInfo& obj)
{
  j["inst"] = obj.inst;
  j["name"] = obj.name;
  j["dir"] = obj.dir;
...
inline void
from_json(const data_t& j, QueueInfo& obj)
{
  if (j.contains("inst"))
    j.at("inst").get_to(obj.inst);
  if (j.contains("name"))
...
inline void
to_json(data_t& j, const ModInit& obj)
{
  j["qinfos"] = obj.qinfos;
}

inline void
from_json(const data_t& j, ModInit& obj)
{
